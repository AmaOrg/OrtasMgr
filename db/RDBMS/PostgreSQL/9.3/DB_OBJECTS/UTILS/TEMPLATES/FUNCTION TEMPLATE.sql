...
-- CREATE FUNCTION %NOME_TABELLA%_tr_fn__%MINI_TR_DESCR%(func_arg0 TYPE, func_arg1 TYPE, func_arg2 TYPE) RETURNS TEXT
CREATE FUNCTION %FUNC_NAME%(func_arg0 TYPE, func_arg1 TYPE, func_arg2 TYPE) RETURNS TEXT
$BODY_FUNC_TR$
DECLARE	
